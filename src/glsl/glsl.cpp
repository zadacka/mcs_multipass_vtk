...
//OpenGL Version: 2.1.0 - Build 8.15.10.1808
...
// GL ERROR CHECK
   int CheckGLError(char *file, int line)
   {
	   ...
	   //GL Error #1282(invalid operation)  in File ..\..\src\libglsl\glsl.cpp at line: 406
	   if (glErr==1282) glErr = GL_NO_ERROR;
...
//----------------------------------------------------------------------------- 
   ...
   bool HasGLSLSupport(void)
   {
      ...
      if (GLEW_VERSION_2_0)
      {
         cout << "STB|INFO :OpenGL 2.0 (or higher) is available" << endl;
      }
      else if (GLEW_VERSION_1_5)
      {
         cout << "STB|INFO :OpenGL 1.5 core functions are available" << endl;
      }
      else if (GLEW_VERSION_1_4)
      {
         cout << "STB|INFO :OpenGL 1.4 core functions are available" << endl;
      }
      else if (GLEW_VERSION_1_3)
      {
         cout << "STB|INFO :OpenGL 1.3 core functions are available" << endl;
      }
      else if (GLEW_VERSION_1_2)
      {
         cout << "STB|INFO :OpenGL 1.2 core functions are available" << endl;
      }
      ...
      if (useGLSL)
      {
          cout << "STB|INFO :OpenGL Shading Language is available\n";
      }
      else
      {
          cout << "STB|ERROR:OpenGL Shading Language is not available.\n";
      }   
